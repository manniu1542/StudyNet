...
namespace TestThreadServerClientSocket
{
    ...
    public class BaseData
    {
        ...
        public virtual void DataByByte(byte[] arrByte)
        {
            //检查字节是否 是所需要的。
    ...
    public static class HandlerCode
    {
        ...
        public static string GetHandlerStr(byte[] msg)
        {
    ...
    public class BaseMsgData : BaseData
    {
        ...
        public override void DataByByte(byte[] arrByte)
        {
            //拿出前四个
            ...
            if (handlerID != -1)
            {
                base.DataByByte(arrData);
            }
            else
            {
                Console.WriteLine("这个 消息码没有定义：" + handlerID);
                return;
            }
